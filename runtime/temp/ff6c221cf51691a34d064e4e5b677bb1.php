<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\phpStudy\WWW\pyg\public/../application/home\view\login\login.html";i:1575602784;}*/ ?>
<!DOCTYPE html>
<html>
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form" action="<?php echo url('home/login/dologin'); ?>" method="post">
								...
								<div class="logined">
									<a class="sui-btn btn-block btn-xlarge btn-danger" href="javascript:void(0);">登&nbsp;&nbsp;录</a>
								</div>
							</form>
							<div class="otherlogin">
								<div class="types">
									<ul>
										...
										<li><img src="/static/home/img/sina.png" /></a></li>
