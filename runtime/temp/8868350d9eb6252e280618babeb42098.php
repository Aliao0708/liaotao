<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"E:\phpStudy\WWW\pyg\public/../application/home\view\goods\detail.html";i:1575774231;s:53:"E:\phpStudy\WWW\pyg\application\home\view\layout.html";i:1575793015;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="py-container">
                <div class="shortcut">
                    <ul class="fl">
                        ...
                        <?php else: ?>
                        <li class="f-item">Hi,<a href="javascript:;" ><?php echo \think\Session::get('user_info.nickname'); ?></a>　<span><a href="<?php echo url('home/login/logout'); ?>">退出</a></span></li>
                        <?php endif; ?>
                    </ul>
                    <ul class="fr">
...
<form action="<?php echo url('home/cart/addcart'); ?>" method="post" style="display: none;">
	...
	<script type="text/javascript">
        ...
        //var value_ids_map = {"28_32":{"id":827,"price":"3200.00"},"28_33":{"id":828,"price":"3500.00"},"29_32":{"id":829,"price":"3000.00"},"29_33":{"id":830,"price":"3000.00"}};
		$(function(){
			// +号点击效果
			$('#plus').click(function(){
				//获取输入框的值
			...
			$('#addshopcar').click(function(){
				//获取选中的规格值对应的spec_goods_id 放到隐藏表单域中
//获取所有选中的规格值 id  拼接成 28_32这种形式
				var value_ids = '';
				$('.selected').each(function(i,v){
					value_ids += $(v).attr('value_id') + '_';
